...
<body>
    ...
    <div class="container col-centered">
        <div class="text-center">
           <a href="${pageContext.request.contextPath}/addLoc">CREATE LOCATION</a>
        </div>
        <table class="table">
            <thead>
            <th>Location</th>
            ...
            <c:forEach var="loc" items="${locationList}">
                <tr>
                    <td><a href="${pageContext.request.contextPath}/displayLocFull?locID=${loc.ID}">${loc.name}</a></td>
                    <td>${loc.address}</td>
                    <td>${loc.latitude},${loc.longitude}</td>
                    <td><a href="${pageContext.request.contextPath}/editLoc?locID=${loc.ID}">Edit</a></td>
                    <td><a href="${pageContext.request.contextPath}/deleteLoc?locID=${loc.ID}">Delete</a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
