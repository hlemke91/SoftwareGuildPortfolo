...
<body>
    ...
    <div class="container">
        <h1>Add Sighting</h1>
            ...
            <form action="createSighting"class="form-control" method="post">
                
                Date:<input type="date"class="form-control" name="date" default="12-31-1990"><br>
                Location:<select class="form-control" name="locID">
                    <c:forEach var="loc" items="${locs}">
                        <option value="${loc.ID}">${loc.name}</option>
                    </c:forEach>
                </select>
                Supers: (hold control for multiple)<select multiple="multiple"class="form-control" name="superID">
