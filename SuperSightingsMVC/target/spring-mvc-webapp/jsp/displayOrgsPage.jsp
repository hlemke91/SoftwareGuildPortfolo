<%-- 
    Document   : displayOrgsPage
    Created on : Nov 1, 2017, 11:18:27 AM
    Author     : Hayden
--%>
        ...
        <div class="container">
            ...
            <div class="navbar">
                ...
                <div class="container">
                    ...
                    <table class="table table-hover col-md-9 col-centered">
                        <thead><th>Name</th><th>Description</th></thead>
                    <c:forEach var="organization" items="${orgs}">
                        <tr>
                            <td><a href="${pageContext.request.contextPath}/displayOrgFull?orgID=${organization.id}">${organization.name}</a></td>
                            <td>${organization.description}</td>
                            <td><a href="${pageContext.request.contextPath}/editOrg?orgID=${organization.id}">Edit</a></td>
                            <td><a href="${pageContext.request.contextPath}/deleteOrg?orgID=${organization.id}">Delete</a></td>
                        </tr>
                    </c:forEach>
                    </table>
                </div>
