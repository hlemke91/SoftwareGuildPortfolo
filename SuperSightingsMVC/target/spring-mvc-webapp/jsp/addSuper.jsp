...
<div class="container">
    <div class ="col-centered">
        ...
        <form action="createSuper"class="form-control" method="post">
            Name:<input type="text"class="form-control"  name="name"><br>
            Identity:<input type="text"class="form-control" name="identity"><br>
            SuperPowers:<input type="text"class="form-control" name="power"><br>
